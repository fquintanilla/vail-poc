...
type MediaTextBlockJsonRtfProps = {
  mediaTextBlockJsonRtf: MediaTextBlockJsonRtf;
};

export function MediaTextBlockJsonRtf(props: MediaTextBlockJsonRtfProps) {
  const mediaTextBlock = props.mediaTextBlockJsonRtf;
